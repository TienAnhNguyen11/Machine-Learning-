...
# Tải dữ liệu và huân luyện 1 SVC

# Đầu tiên, chúng tôi tải tập dữ liệu wine và chuyển đổi nó thành một bài toán
# phân loại nhị phân. Sau đó, chúng tôi đào tạo một trình phân loại
...
# Huấn luyện 1 Randon forest và phác họa đồ thị đường cong ROC
...
# chuyển alpha = 0.8 cho các hàm phác họa để điều chỉnh giá trị alpha của các đường cong.
