...
# Mô hình đào tạo trên bọ dữ liệu giá nhà ở Boston
# Đầu tiên, chúng tôi đào tạo một decision tree và nột
...
# cho decision tree. VỚi 2 tính năng, plot_partial_dependence dự kiến sẽ vẽ 2 đường cong.
# ở đây, chức năng vẽ đồ thị đặt một lưới gồm 2 ô bằng cách sử dụng khoảng trắng được xác định bởi ax.

fig, ax = plt.subplots(figsize=(12, 6))
ax.set_title("Decision Tree")
tree_disp = plot_partial_dependence(tree, X, ["LSTAT", "RM"], ax=ax)

# Các đường cong phụ thuộc một phần có thể được vẽ cho perceptron nhiều lớp. Trong trường hợp này,
...
# và 2 cột. Các trực được truyền vào hàm vẽ dưới dạng 1 danh sách, nó sẽ vẽ các đường cong phụ thuộc
# một phần của mỗi mô hình trên cùng một trục. Độ dài của danh sách trục phải bằng số lượng ô được  vẽ

# Đặt hình ảnh này làm hình thu nhỏ cho thư viện nhân sự
...
# "LSTAT", trên cùng một trục. Trong trường hợp này, tree_disp.axes_ được truyền vào hàm phác họa thứ 2
